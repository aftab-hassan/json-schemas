function $_global_clienttemplates() {
        ...
        if (fRenderHeaderColumnNames) {
            ...
            for (var f in fields) {
                ...
                if (IsCSRReadOnlyTabularView(renderCtx) && (field.CalloutMenu == "TRUE" || field.listItemMenu == "TRUE"))
                    ret.push('<th aria-label="' + Encoding.HtmlEncode(window["ListView"]["Strings"]["L_OpenMenu_Text"]) + '" role="columnheader"></></th>');
            }
        }
        if (listSchema.TabularView == "1" && renderCtx.BasePermissions.ManageLists && renderCtx.ListTemplateType != 160) {
            ret.push('<th class="ms-vh-icon" scope="col" title="" role="presentation"><span class="ms-addcolumn-span"> </span></th>');
        }
        ret.push("</tr>");
        ret.push("</thead>");
    ...
    if (typeof window.ComputedFieldWorker != "function") {
        window.ComputedFieldWorker = (function() {
            ...
            function GenBlogLink(link, altText, position, titleText, descText, listSchema, listItem) {
                ...
                ret.push("\" style=\"height:16px;width:16px;display:inline-block;\" ><img src=\"" + ListView.ImageBasePath + "/_layouts/15/images/fgimg.png?rev=47" + "\" alt=\"");
                ret.push(altText);
            ...
            function GetFolderIconSourcePath(listItem) {
                if (listItem["HTML_x0020_File_x0020_Type.File_x0020_Type.mapico"] == '')
                    return ListView.ImageBasePath + "/_layouts/15/images/folder.gif?rev=47";
                else
            ...
            function LinkFilenameNoMenuInternal(renderCtx, listItem, listSchema) {
                ...
                if (fileUrl != null && typeof fileUrl != 'undefined' && TrimSpaces(fileUrl) != "") {
                    if (listItem.FSObjType == '1') {
                        ...
                        fileRefHref = Flighting.VariantConfiguration.IsExpFeatureClientEnabled(54) ? Encoding.HtmlEncodeEx(fileRefHref) : Encoding.HtmlEncode(fileRefHref);
                        var serverUrlProgId;
                        ...
                        if (Flighting.VariantConfiguration.IsExpFeatureClientEnabled(90)) {
                            serverUrlProgId = Encoding.ScriptEncode(listItem["serverurl.progid"]);
                        }
                        else {
                            serverUrlProgId = listItem["serverurl.progid"];
                        }
                        if ((window["OffSwitch"] == null || OffSwitch.IsActive("88E16BF7-E8BC-4ABA-ABE7-001818C101E8")) && Flighting.VariantConfiguration.IsExpFeatureClientEnabled(164) && listItem["File_x0020_Type.mapapp"] == "ms-word" || Flighting.VariantConfiguration.IsExpFeatureClientEnabled(194) && listItem["File_x0020_Type.mapapp"] == "ms-powerpoint" || Flighting.VariantConfiguration.IsExpFeatureClientEnabled(225) && listItem["File_x0020_Type.mapapp"] == "ms-visio" || Flighting.VariantConfiguration.IsExpFeatureClientEnabled(181) && listItem["File_x0020_Type.mapapp"] == "ms-excel") {
                            serverUrlProgId = serverUrlProgId.replace("WopiFrame.aspx", "doc.aspx");
                            if (!(window["OffSwitch"] == null || OffSwitch.IsActive("8682DDE6-14A4-4290-876C-8D1F5AFD46E0"))) {
                                if (listItem["File_x0020_Type.mapapp"] != "ms-visio" && listItem["File_x0020_Type.mapapp"] != "ms-excel") {
                                    serverUrlProgId = serverUrlProgId.replace("action=default", "action=edit");
                                }
                            }
                            else {
                                serverUrlProgId = serverUrlProgId.replace("action=default", "action=edit");
                        ...
                        if (IsFileHandlerForAllNonOfficeFilesSupported()) {
                            if (IsFileExtensionControlsSupported() && ShouldCallSuiteExtensionControlFactory(renderCtx)) {
                                ...
                                if (!(window["OffSwitch"] == null || OffSwitch.IsActive("9E9D50DD-3F1B-4186-8AC0-80E9634B2891"))) {
                                    ret.push(Encoding.ScriptEncode(listItem["File_x0020_Type"]));
                                }
                                else {
                        ...
                        ret.push(Encoding.HtmlEncode(fileRef));
                        ret.push("</a>");
                    ...
                    ret.push("<nobr>");
                    ret.push(Encoding.HtmlEncode(listItem["FileLeafRef"]));
                    ret.push("</nobr>");
                }
                return ret.join('');
            }
            function RenderType(renderCtx, field, listItem, listSchema) {
                var ret = [];
                var fileLeafRef = Encoding.HtmlEncode(listItem.FileLeafRef);
                ...
                if (ListModule.Settings.SupportsAddToOneDrive && Boolean(IsMountPoint(listItem))) {
                    ...
                    ret.push(fileLeafRef);
                    ret.push("\" src=\"");
                    ret.push(ListView.ImageBasePath + "/_layouts/15/images/SharedFolder16.png?rev=47");
                    ret.push("\" />");
                    ret.push("</a>");
                }
                else if (ListModule.Settings.SupportsShortcutLink && Boolean(IsShortcutLink(listItem))) {
                    ...
                    if (hasPolicyTip()) {
                        ...
                        if (typeof listItem.IconOverlay != 'undefined' && listItem.IconOverlay != '') {
                            ...
                            if (!(window["OffSwitch"] == null || OffSwitch.IsActive("B35674E3-5E63-4A44-AF45-127010C82E7D"))) {
                                ret.push(Encoding.HtmlEncode(listItem["IconOverlay.mapoly"]));
                            }
                            else {
                    ...
                    if (listSchema.IsDocLib == '1') {
                        if (typeof listItem.IconOverlay == 'undefined' || listItem.IconOverlay == '') {
                            ...
                            var blockDeleteByComplianceFlags = typeof listItem["_ComplianceFlags"] !== 'undefined' && listItem["_ComplianceFlags"] != null && (listItem["_ComplianceFlags"] & 4) == 4;
            ...
            return {
                ...
                Edit: function(renderCtx, field, listItem, listSchema) {
                    if (ListModule.Util.hasEditPermission(listItem)) {
                        ...
                        ret.push("\" src=\"" + ListView.ImageBasePath + "/_layouts/15/images/edititem.gif?rev=47" + "\"/></a>");
                        return ret.join('');
                    }
                    else {
                        return "&nbsp;";
                ...
                _IsRecord: function(renderCtx, field, listItem, listSchema) {
                    var blockDeleteByComplianceFlags = typeof listItem["_ComplianceFlags"] !== 'undefined' && listItem["_ComplianceFlags"] != null && ((listItem["_ComplianceFlags"] & 4) == 4 || (listItem["_ComplianceFlags"] & 256) == 256);
    ...
    RenderCalloutMenu = function(renderCtx, listItem, field, content, fMakeNewColumn) {
        ...
        ret.push("\" id=\"");
        ret.push(listItem.ID);
        if (!OffSwitch.IsActive("18AE54C9-EB03-45F3-8768-DFB1CC034209")) {
            if (listItem.PermMask) {
                ret.push("\" Perm=\"");
                ret.push(listItem.PermMask);
            }
        }
    ...
    getDocumentIconAbsoluteUrl = function(listItem, size, renderCtx) {
        var assetLibPreviewValueExists = function(fieldName) {
            return listItem[fieldName + ".value"] == "1" && ListModule.Util.isDefinedAndNotNullOrEmpty(listItem["FileLeafRef.Name"]) && ListModule.Util.isDefinedAndNotNullOrEmpty(fileExtension) || listItem[fieldName + ".value"] == "" && renderCtx != null && renderCtx.ListTemplateType == 109;
        };
    ...
    if (!(window["OffSwitch"] == null || OffSwitch.IsActive("39A8E192-9EFC-4922-9FD8-343D685E163C"))) {
        LocationFieldRenderer_InitializePrototype();
    }
...
function InitListViewFlightSettings() {
    ...
    ListModule.Settings.SupportsInfiniteScroll = false;
...
function RenderListView(renderCtx, wpq, templateBody, bAnimation, bRenderHiddenFooter) {
    ...
    if (Boolean(renderCtx)) {
        ...
        if (Boolean(renderCtx.ListSchema) && renderCtx.ListSchema.IsDocLib) {
            ...
            if (!(window["OffSwitch"] == null || OffSwitch.IsActive("F9CBDAF1-ABF2-46B2-A9EB-1785D1FDD9A5"))) {
                DisplayRevertToClassicHomepageIfNeeded(renderCtx);
            }
        }
        if (Boolean(renderCtx.ListSchema) && renderCtx.ListSchema.IsDocLib) {
...
function RenderGroupTemplate(renderCtx, group, groupId, listItem, listSchema, level, expand) {
    ...
    iStr += '">';
    if (level == 2)
        iStr += '<img src=' + ListView.ImageBasePath + '"/_layouts/15/images/blank.gif?rev=47"' + ' alt="" height="1" width="10">';
...
function RenderViewSelectorMenu(renderCtx) {
    ...
    ret.push('<img src="');
    ret.push(ListView.ImageBasePath + "/_layouts/15/images/fgimg.png?rev=47");
    ret.push('" alt="');
...
function RenderPaging(ret, renderCtx) {
    ...
    if (listData != null && (listData.PrevHref != null || listData.NextHref != null)) {
        ...
        if (listData.PrevHref != null && !IsInfiniteScrollSupported(renderCtx)) {
            ...
            str.push(Encoding.HtmlEncode(listData.PrevHref));
        ...
        if (listData.NextHref != null) {
            ...
            str.push("\" onclick='RefreshPageTo(event, \"");
            str.push(Encoding.HtmlEncode(listData.NextHref));
            str.push("\");return false;'");
            str.push(" href=\"javascript:\" class=\"ms-commandLink ms-promlink-button ms-promlink-button-enabled\"><span class=\"ms-promlink-button-image\"><img src=\"");
            str.push(GetThemedImageUrl("spcommon.png"));
            str.push("\" border=\"0\" class=\"");
...
function RenderHeroParameters(renderCtx, delay) {
    ...
    else if (listTemplate == 101 || listTemplate == 700 || listTemplate == 702 || renderCtx.listBaseType == 1 && listTemplate >= 10000) {
        if (this.WOPIEnabled) {
    ...
    this.addNewUrl = url;
    if (!(window["OffSwitch"] == null || OffSwitch.IsActive("ADD1696D-37A8-41CF-AFB8-BCDB4D70B4FE"))) {
        this.largeSize = true;
    }
    else {
...
function RenderHeroLink(renderCtx, delay) {
    var isCustomListInGroup = Flighting.VariantConfiguration.IsExpFeatureClientEnabled(437) && renderCtx.SiteTemplateId == 64 && renderCtx.listTemplate == "100" && (window["OffSwitch"] == null || OffSwitch.IsActive("E5476C60-BE39-4AD0-B185-AB24370E049E"));
...
function RenderHeroAddNewLink(heroParam, renderCtx) {
    ...
    if (!heroParam.WOPIEnabled) {
        ...
        ret.push(", &quot;");
        if (!(window["OffSwitch"] == null || OffSwitch.IsActive("DC62F4FA-E21D-4BFF-ACDB-D1E213C7D260"))) {
            ret.push(Encoding.ScriptEncode(heroParam.addNewUrl));
        }
        else {
            ret.push(heroParam.addNewUrl);
        }
...
function DisplayRevertToClassicHomepageIfNeeded(renderCtx) {
    if (Boolean(_spPageContextInfo) && Boolean(_spPageContextInfo["isSiteAdmin"])) {
        var loadRevertToClassicIfNecessary = createOneTimeCallback(function() {
            var uri = new URI(Nav.ajaxNavigate.get_href());
            var revertQuery = uri.getQueryParameter("BackToClassicHomepage");

            if (Boolean(revertQuery)) {
                CoreInvoke('AddStatusRevertToClassicHomepage');
            }
        });

        AddPostRenderCallback(renderCtx, loadRevertToClassicIfNecessary);
    }
}
...
function LogCalculatedScript(val) {
    if (ListModule.Util.isDefinedAndNotNullOrEmpty(val) && (val.indexOf("<") != -1 || val.indexOf(">") != -1)) {
        WriteEngagementLog("CalculatedFieldHasScript", {
            script: val
        });
    }
}
function NumberFieldRendererRenderField(renderCtx, field, listItem, listSchema) {
    ...
    if (!(window["OffSwitch"] == null || OffSwitch.IsActive("856528C6-8452-44E4-A756-32C6E13004E3")) && field.FieldType == "Calculated") {
        if (Flighting.VariantConfiguration.IsExpFeatureClientEnabled(68) || Boolean(_spPageContextInfo) && Boolean(_spPageContextInfo.AllowCustomMarkupInCalculatedField))
            val = Encoding.HtmlEncode(val);
        else {
            if (!field.scriptLogged) {
                field.scriptLogged = true;
                LogCalculatedScript(val);
            }
        }
    }
...
function BusinessDataFieldRendererRenderField(renderCtx, field, listItem, listSchema) {
    ...
    if (Boolean(fieldDefinition.HasActions)) {
        ...
        ret += '<img border="0" align="absmiddle" src=' + ListView.ImageBasePath + "/_layouts/15/images/bizdataactionicon.gif?rev=47" + ' tabindex="0" alt="' + window["ListView"]["Strings"]["L_BusinessDataField_ActionMenuAltText"] + '" title="' + window["ListView"]["Strings"]["L_BusinessDataField_ActionMenuAltText"] + '"';
        ret += ' onclick="' + onclickMethod + '"';
        ret += ' onkeydown="' + onKeyDownMethod + '" />';
        ret += '</a>';
        ret += '<a>';
        ret += '<img align="absmiddle" src=' + ListView.ImageBasePath + "/_layouts/15/images/menudark.gif?rev=47" + ' tabindex="0" alt="' + window["ListView"]["Strings"]["L_BusinessDataField_ActionMenuAltText"] + '"';
        ret += ' onclick="' + onclickMethod + '"';
        ret += ' onkeydown="' + onKeyDownMethod + '" />';
        ret += '</a>';
        ret += '</span>';
...
function DateTimeFieldRendererRenderField(renderCtx, field, listItem, listSchema) {
    ...
    if (!(window["OffSwitch"] == null || OffSwitch.IsActive("856528C6-8452-44E4-A756-32C6E13004E3")) && field.FieldType == "Calculated") {
        if (Flighting.VariantConfiguration.IsExpFeatureClientEnabled(68))
            absoluteDateTimeString = Encoding.HtmlEncode(absoluteDateTimeString);
        else {
            if (!field.scriptLogged) {
                field.scriptLogged = true;
                LogCalculatedScript(absoluteDateTimeString);
            }
        }
    }
...
function LookupFieldRendererRenderField(renderCtx, field, listItem, listSchema) {
    ...
    for (var i = 0; i < fieldValue.length; i++) {
        ...
        if (window["OffSwitch"] == null || OffSwitch.IsActive("9A1172B1-4735-4132-B0A3-8CD8CFF199E8"))
            sbUrl.push(Encoding.ScriptEncode(field.DispFormUrl));
        else
        ...
        if (!(window["OffSwitch"] == null || OffSwitch.IsActive("9A1172B1-4735-4132-B0A3-8CD8CFF199E8")))
            ret.push(Encoding.ScriptEncode(url));
        else
            ret.push(url);
...
function LocationFieldRenderer_InitializePrototype() {
    LocationFieldRenderer.prototype = {
        fldName: null,
        RenderField: LocationFieldRendererRenderField
    };
}
function LocationFieldRenderer(fieldName) {
    this.fldName = fieldName;
}
function LocationFieldRendererRenderField(renderCtx, field, listItem, listSchema) {
    var locationVal = listItem[this.fldName];
    var retValue;

    if (locationVal.DisplayName) {
        retValue = locationVal.DisplayName;
    }
    else if (locationVal.Address && locationVal.Address.Street) {
        retValue = locationVal.Address.Street;
    }
    return Encoding.HtmlEncode(retValue);
}
...
function RenderUserFieldWorker(renderCtx, field, listItem, listSchema) {
    var g_EmptyImnPawnHtml = "<span class='ms-spimn-presenceLink'><span class='{0}'><img class='{1}' name='imnempty' src='" + ListView.ImageBasePath + "/_layouts/15/images/spimn.png?rev=47" + "' alt='' /></span></span>";
    var g_ImnPawnHtml = "{0}<a href='#' onclick='WriteDocEngagementLog(\"DocModifiedByPresenceClick\", \"ODModifiedByPresenceClick\"); IMNImageOnClick(event);return false;' class='{1}' {2}>{3}<img name='imnmark' title='' ShowOfflinePawn='1' class='{4}' src='" + ListView.ImageBasePath + "/_layouts/15/images/spimn.png?rev=47" + "' alt='";
    var ret = [];
    ...
    function UserLinkWithSize(pictureSize) {
        ...
        if (field.HasUserLink && (Boolean(userDispParam) || lookupId != null && lookupId != '' && parseInt(lookupId) > -1)) {
            ...
            if (!Boolean(listSchema.UserDispUrl) && Boolean(_spPageContextInfo) && Boolean(_spPageContextInfo.webServerRelativeUrl)) {
    ...
    function RenderPicture(fieldToRender) {
        ...
        if (picture == null || picture == '') {
            if (ListModule.Settings.SupportsCrossDomainPhotos && _spPageContextInfo.crossDomainPhotosEnabled) {
                ...
                ret.push(ListView.ImageBasePath + "/_layouts/15/images/person.gif?rev=47");
            }
            ret.push("\" alt=\"");
...
function SPMgr() {
    ...
    function DefaultRenderField(renderCtx, field, listItem, listSchema) {
        if (typeof field.FieldRenderer == 'undefined') {
            ...
            if (!(window["OffSwitch"] == null || OffSwitch.IsActive("39A8E192-9EFC-4922-9FD8-343D685E163C"))) {
                fieldRenderMap.Location = new LocationFieldRenderer(field.Name);
            }
    ...
    function RenderDVTHeaderField(renderCtx, field) {
        ...
        if (field.Sortable != 'FALSE' && field.Type != 'MultiChoice' || field.Filterable != 'FALSE' && field.Type != 'Note' && field.Type != 'URL') {
            ...
            iStr += '" aria-expanded="false"><img style="visibility: hidden;" src="' + GetThemedImageUrl("ecbarw.png") + '" alt="';
            iStr += sortfilterlabel;
